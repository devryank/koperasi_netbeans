...
//        tblPosition.getModel().getValueAt(row, col);
    ...
    protected void datatable() {
        ...
        try {
            String sql = "SELECT p.*, tt.name as type_name from products p INNER JOIN categories tt ON p.category_id = tt.id where p.product_code like '%"+cariitem+"%' or p.name like '%"+cariitem+"%' order by p.product_code asc";
