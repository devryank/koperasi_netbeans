 ...
 * @author Lenovo
 */
public class ReadCategories extends javax.swing.JFrame {
...
//        tblPosition.getModel().getValueAt(row, col);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(id != 0) {
            UpdateCategories update = new UpdateCategories(id);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        CreateCategories create = new CreateCategories();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReadCategories.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReadCategories().setVisible(true);
            }
        });
    }
