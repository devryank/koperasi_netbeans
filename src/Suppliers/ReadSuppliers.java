 ...
 * @author Lenovo
 */
public class ReadSuppliers extends javax.swing.JFrame {
...
//        tblPosition.getModel().getValueAt(row, col);
    ...
    protected void datatable() {
        ...
        try {
            String sql = "SELECT * from suppliers where id like '%"+cariitem+"%' or name like '%"+cariitem+"%' order by id asc";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(id != 0) {
            UpdateSuppliers update = new UpdateSuppliers(id);
    ...
    private void tblSuppliersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSuppliersMouseClicked
        ...
        try {
            id = Integer.valueOf((String) tblSuppliers.getModel().getValueAt(row, col));
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        CreateSuppliers create = new CreateSuppliers();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReadSuppliers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReadSuppliers().setVisible(true);
            }
        });
    }
