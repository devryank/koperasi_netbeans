 ...
 * @author Lenovo
 */
public class CreateExits extends javax.swing.JFrame {
...
private SimpleDateFormat date;
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            ...
            String sql = "insert into exits values(0,?,?,STR_TO_DATE(?, '%Y-%m-%d'))";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateExits.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateExits().setVisible(true);
            }
        });
    }
